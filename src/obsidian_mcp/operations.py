...
# Unicode -> ASCII replacements to normalize AI-generated fancy typography
_TYPOGRAPHY_MAP = {
    # Dashes
    "\u2014": "-",  # em-dash
    "\u2013": "-",  # en-dash
...
_TYPOGRAPHY_TRANS = str.maketrans(_TYPOGRAPHY_MAP)


def normalize_typography(text: str) -> str:
    """Replace fancy unicode typography with ASCII equivalents."""
...
class Operations:
    ...
    def create(
        ...
        warnings.extend(self._validator.validate_section_sizes(file_content))
    ...
    def append(self, name: str, text: str) -> WriteResult:
        ...
        warnings.extend(self._validator.validate_section_sizes(new_content))
        warnings.extend(link_warnings)
