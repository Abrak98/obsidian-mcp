...
def get_logger(name: str) -> logging.Logger:
    ...
    Environment variables:
        LOG_DIR_NAME: subdirectory in logs/ (default: "default")
        LOG_LEVEL: DEBUG, INFO, WARNING, ERROR (default: "INFO")

    Set in entrypoint before imports:
        os.environ["LOG_DIR_NAME"] = "pipeline"
    ...
    py_logger.setLevel(getattr(logging, log_level, logging.INFO))
